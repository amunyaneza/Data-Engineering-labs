...
- [Project ETL: Extract from URL, Transform GDP, Load to CSV file and Database](Lab4/etl_project_gdp.py)
- [Python project for Data Engineering (ETL)](Lab5/banks_project.py)
